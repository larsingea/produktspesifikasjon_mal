...
> **Språk:** nor<br>
> **Kontaktinformasjon:** Landbruksdirektoratet, [vibeke.godal@landbruksdirektoratet.no](mailto:vibeke.godal@landbruksdirektoratet.no)

## Om produktet Bopliktsområder


> **Romlig representasjonstype:** Vektor<br>
> **Unik identifikator:** <https://data.geonorge.no/sosi/plan/bopliktsomrader><br>
> **Kontaktinformasjon:** Landbruksdirektoratet, [vibeke.godal@landbruksdirektoratet.no](mailto:vibeke.godal@landbruksdirektoratet.no)
>
> **Romlig oppløsning:**
>
...
>
> - **Tilgangsbegrensninger**: Beskyttet
...
> - **Andre begrensninger**: Når datasettet er ferdig vil dataene bli åpne
...
<a href="filleveranser-full-modell/filleveranser-full-modell_feature_catalogue.png" title="Klikk for stor visning"><img src="filleveranser-full-modell/filleveranser-full-modell_feature_catalogue.png" alt="Datamodell Filleveranser - full modell" style="max-width: 100%; height: auto;" /></a>



➡️ [Se full datamodell for omfang "Filleveranser - full modell" (diagram per pakke og objektkatalog)](filleveranser-full-modell/objektkatalog.html)
...
| --- | --- | --- | --- | --- |
| OGC API-Features | [Lenke](https://inndelinger.api.kartverket.no/) | OGC:API-Features | GeoJSON | landsfiler |
