...
**Kilde:** [GeoPackage](https://arnevik.net/test/dyrkbarjord_tom_25833.gpkg)
...
<table class="feature-attribute-table">
  ...
  <tbody>
    <tr>
      <th scope="row">Navn:</th>
      <td><strong>avgrensesavarealressursgrense_1</strong></td>
    </tr>
    <tr>
      <th scope="row">Multiplisitet:</th>
      <td>0..1</td>
...
<table class="feature-attribute-table">
  ...
  <tbody>
    <tr>
      <th scope="row">Navn:</th>
      <td><strong>avgrensesavarealressursgrense_2</strong></td>
    </tr>
    <tr>
      <th scope="row">Multiplisitet:</th>
      <td>0..1</td>
...
<table class="feature-attribute-table">
  ...
  <tbody>
    <tr>
      <th scope="row">Navn:</th>
      <td><strong>avgrensesavarealressursgrense_3</strong></td>
    </tr>
    <tr>
      <th scope="row">Multiplisitet:</th>
      <td>0..1</td>
